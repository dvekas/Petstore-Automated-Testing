...
public class UserRequests {
    ...
    public User getUserByUserName(String userName) {
        return customObjectMapper.mapObjectFromResponse(requestController.getEntity(BASE_URI + userName, HttpStatus.SC_OK, null), User.class);
    }
    ...
    public APIResponse getNonExistentUser(String userName) {
        return customObjectMapper.mapObjectFromResponse(requestController.getEntity(BASE_URI + userName, HttpStatus.SC_NOT_FOUND, null), APIResponse.class);
    }
     ...
     * @return The created User, from the response body of the API call
     */
    public APIResponse createNewUser(User userToCreate) {
        return customObjectMapper.mapObjectFromResponse(requestController.createNewEntity(BASE_URI, userToCreate, HttpStatus.SC_OK), APIResponse.class);
    }
    ...
    public APIResponse logInUser(String userName, String userPassword) {
        ...
        return customObjectMapper.mapObjectFromResponse(requestController.getEntity(logInURI, HttpStatus.SC_OK, logInHeaders), APIResponse.class);
    }
    ...
    public APIResponse logOutUser() {
        return customObjectMapper.mapObjectFromResponse(requestController.getEntity(BASE_URI + "logout", HttpStatus.SC_OK, null), APIResponse.class);
    }
}
